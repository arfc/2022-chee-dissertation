...
\begin{frame}
    ...
    \vspace{0.2cm}
    \begin{figure}
        \only<1>{\includegraphics[width=0.8\linewidth]{../docs/figures/assem-obj-2-pfppf-pareto-distr.png}}
        \only<2>{\includegraphics[width=0.8\linewidth]{figures/assem-obj-2-pfppf-pareto-distr-annotated.png}}
    \end{figure}
\end{frame}
...
\begin{frame}
    ...
    \only<2>{\begin{column}{0.4\textwidth}
        ...
        \item Reactor 2 = minimizes all objectives to an equal extent 
        \end{itemize}
        \end{block}
        \end{column}}
...
\begin{frame}
    ...
    \vspace{0.2cm}
    \begin{figure}
        \only<1>{\includegraphics[width=0.7\linewidth]{../docs/figures/assem-obj-3-all-distr.png}}
        \only<2>{\includegraphics[width=0.7\linewidth]{figures/assem-obj-3-all-distr-annotated.png}}  
    \end{figure}
\end{frame}
...
\begin{frame}
    ...
    \begin{columns}
        ...
        \begin{figure}
            \only<1>{\includegraphics[width=\linewidth]{figures/a-3b-four-disr.png}} 
            \only<2>{\includegraphics[width=\linewidth]{figures/a-3b-four-disr.png}} 
            \only<3>{\includegraphics[width=\linewidth]{figures/a-3b-four-disr.png}} 
        \end{figure}
        \end{column}
        \begin{column}{0.4\textwidth}
            \textbf{Key Observations}
            \begin{itemize}
                \visible<1->{\item TRISO distribution flatness is influenced by minimize $T_{max}$
                objective} 
                \visible<2->{\item Variations in TRISO distributions are influenced by minimize 
                $PF_{total}$ and $PPF_{fuel}$ objectives} 
                \visible<3->{\item Larger radius values are observed near temperature peaks} 
            \end{itemize}
        \end{column}
        \end{columns}
\end{frame}
...
\begin{frame}
    ...
    \visible<4->{\textbf{Minimize $PF_{total}$ and $PPF_{fuel}$} 
    \begin{itemize}
    \item Influences variations in TRISO distributions
