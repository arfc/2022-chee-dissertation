...
\begin{frame}
    ...
    \begin{figure}
        \centering
        \includegraphics[width=0.48\linewidth]{../docs/figures/a-2b-pf-most-minimized.png} 
        \includegraphics[width=0.48\linewidth]{../docs/figures/a-2b-ppf-most-minimized.png} 
        \includegraphics[width=0.48\linewidth]{../docs/figures/a-2b-both-most-minimized.png}
        \caption{Simulation a-2b Pareto Front's TRISO Distributions.}
    \end{figure}
...
\begin{frame}
    ...
    \begin{column}{0.3\textwidth}
        I vary $PF_{total}$, \textbf{a, b, c, d, e f} ($\rho_{TRISO}(\vec{x}, \vec{y}$)), 
        and $r_1, r_2, r_3, r_4, r_5$ (coolant channel shape). \\
        I minimize all three objectives: $PF_{total}$, $T_{max}$ and $PPF_{fuel}$. \\
        6 generations \\
        128 reactor models per gen \\
        Total runtime: 1528 Theta node-hours 
        \end{column}
\end{columns}
\end{frame}
