...
\begin{frame}
    ...
    \begin{figure}
        \centering
        \includegraphics[width=0.4\linewidth]{../docs/figures/a-2b-pf-most-minimized.png} 
        \includegraphics[width=0.4\linewidth]{../docs/figures/a-2b-ppf-most-minimized.png} 
        \includegraphics[width=0.4\linewidth]{../docs/figures/a-2b-both-most-minimized.png}
        \caption{Simulation a-2b Pareto Front's TRISO Distributions.}
    \end{figure}
