...
\begin{frame}
    \frametitle{AHTR One-Third Assembly Optimization Simulations}
        \begin{figure}
            \only<1>{\includegraphics[width=0.95\linewidth]{figures/ahtr-assem-opt-table.png}} 
        ...
        \visible<3->{
        Simulation a-2b shows how $PF_{total}$ and $\rho_{TRISO}(\vec{r})$ 
        change when the minimize $PF_{total}$ and $PPF_{fuel}$ objectives interact.}
\end{frame}
