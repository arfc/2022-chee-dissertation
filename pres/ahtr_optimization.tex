    ...
    \begin{columns}[t]
        ...
        \only<2>{\begin{column}{0.5\textwidth}
            ...
            \begin{itemize}
                ...
                \item For each reactor model on the pareto front, none of the objective 
                values can be improved without degrading another.
                \item Successful multi-objective optimization finds a wide spread of 
