...
\begin{frame}
    ...
    \begin{itemize}
        \item Driven by \textbf{maximizing total fission reaction rate} and 
        influences oscillations in TRISO's spatial distribution
    ...
    \begin{itemize}
        \item Driven by \textbf{flattening thermal flux distribution} and 
        influences oscillations in TRISO's spatial distribution
        \item No correlation with coolant channel shape  
    \end{itemize}
\end{frame}
