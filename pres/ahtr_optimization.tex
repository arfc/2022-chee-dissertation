...
\begin{frame}
    ...
    \begin{columns}
        \begin{column}{0.7\textwidth}
    \begin{figure}
        \only<1>{\includegraphics[width=\linewidth]{../docs/figures/assem-obj-3-all-distr.png}}
        \only<2>{\includegraphics[width=\linewidth]{figures/assem-obj-3-all-distr-annotated.png}}  
...
\begin{frame}
    \frametitle{AHTR One-Third Assembly Simulation a-3b Results}
    \begin{figure}
        \includegraphics[width=0.7\linewidth]{../docs/figures/assem-obj-3-all-min-all.png} 
