...
\begin{frame}
    \frametitle{AHTR One-Third Assembly Optimization Simulations}
        \begin{figure}
            \only<1>{\includegraphics[width=0.8\linewidth]{figures/ahtr-assem-opt-table.png}} 
            \only<2>{\includegraphics[width=\linewidth]{figures/ahtr-assem-opt-table-annotated1.png}} 
            \only<3>{\includegraphics[width=\linewidth]{figures/ahtr-assem-opt-table-annotated2.png}} 
            \only<4>{\includegraphics[width=\linewidth]{figures/ahtr-assem-opt-table-annotated3.png}} 
            \end{figure}
        \visible<1>{
            All the optimization simulations are run on the Theta supercomputer at the 
            Argonne Leadership Computing Facility \cite{noauthor_thetathetagpu_2022}.
        }
        \visible<2>{
        Simulations a-1b and a-1e show \textbf{how the $\rho_{TRISO}(\vec{r})$ and 
        coolant channel shape varying parameters respond to 
