...
\begin{frame}
    ...
    \begin{column}{0.35\textwidth}
        \only<1>{\begin{block}{Simulation a-2b}
        \begin{itemize}
        ...
        \end{itemize}
        \end{block}}
        \only<2>{\begin{block}{Pareto Front}
            Multi objective optimization with competing objectives will return multiple 
            optimal solutions that meet each objective to varying degrees; this set of 
