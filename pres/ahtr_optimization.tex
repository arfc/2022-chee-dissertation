...
\begin{frame}
    ...
    \begin{columns}[t]
        ...
        \vspace{0.1cm}
        \visible<2->{Two sine distributions govern TRISO packing fraction distribution:
        \vspace{-0.2cm} 
        \begin{align}
        ...
        \end{column}
        \begin{column}{0.5\textwidth} 
            \visible<2->{Five radius values (\textbf{$r_1, r_2, r_3, r_4, r_5$}) 
...
\begin{frame}
    ...
    \begin{figure}
        \includegraphics[width=\linewidth]{figures/ahtr-modeling-workflow.png} 
