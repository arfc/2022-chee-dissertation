...
\begin{frame}
    ...
    \begin{columns}[t]
        ...
        \vspace{0.1cm}
        \visible<2->{\textbf{Two sine distributions govern TRISO packing fraction 
        distribution:}
        \vspace{-0.2cm} 
        \begin{align}
        ...
        \end{column}
        \begin{column}{0.5\textwidth} 
            \visible<3->{\textbf{Five radius values (\textbf{$r_1, r_2, r_3, r_4, r_5$}) 
...
\begin{frame}
    ...
    \begin{figure}
        \makebox[\textwidth][c]{
            \includegraphics[width=1.1\linewidth]{figures/ahtr-modeling-workflow.png}} 
...
\begin{frame}
    ...
    \only<1>{
        \begin{figure}
        \includegraphics[width=0.87\linewidth]{figures/ahtr-assem-opt-table.png} 
        \caption{ROLLO simulations for optimizing the AHTR one-third assembly.}
        \end{figure}}
        \only<2>{
            \begin{figure}
            \includegraphics[width=0.87\linewidth]{figures/ahtr-assem-opt-table-annotated.png} 
            \caption{ROLLO simulations for optimizing the AHTR one-third assembly.}
            \end{figure}}
\end{frame}
