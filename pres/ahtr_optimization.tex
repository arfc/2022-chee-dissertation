...
\begin{frame}
    \frametitle{AHTR One-Third Assembly Simulation a-2b Results}
    \begin{figure}
        \makebox[1.1\textwidth]{\includegraphics[width=0.32\linewidth]{../docs/figures/a-2b-pf-most-minimized.png} 
        \includegraphics[width=0.32\linewidth]{../docs/figures/a-2b-ppf-most-minimized.png} 
        \includegraphics[width=0.32\linewidth]{../docs/figures/a-2b-both-most-minimized.png}}
        \caption{Simulation a-2b Pareto Front's TRISO Distributions.}
    \end{figure}
