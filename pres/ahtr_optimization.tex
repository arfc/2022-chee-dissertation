...
\begin{frame}
    ...
    \begin{figure}
        \only<1>{\includegraphics[width=\linewidth]{../docs/figures/ahtr-fuel-element.png}} 
        \only<2>{\includegraphics[width=\linewidth]{figures/ahtr-fuel-element-annotated.png}} 
    \end{figure}
\end{frame}
