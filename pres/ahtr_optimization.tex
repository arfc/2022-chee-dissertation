...
\begin{frame}
    ...
    \begin{tcolorbox}[colback=illiniorange,colframe=illiniorange!50!black]
        \textbf{A flatter TRISO distribution minimizes the \frac{1}{3} assembly's 
        $T_{max}$.}
    \end{tcolorbox}
\end{frame}
...
\begin{frame}
    ...
    Minimize $PF_{total}$ objective 
    \begin{itemize}
        \item Driven by \textbf{maximizing total fission reaction rate}. 
    ...
    \begin{itemize}
        \item 
    \end{itemize}
    Minimize $PPF_{fuel}$ objective 
    \begin{itemize}
        \item Driven by \textbf{flattening thermal flux distribution}. 
        \item No correlation with coolant channel shape  
    \end{itemize}
\end{frame}
