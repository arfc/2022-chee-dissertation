...
\begin{frame}
    \frametitle{AHTR One-Third Assembly Simulation a-1e Results}
    \begin{figure}
        \includegraphics[width=0.49\linewidth]{../docs/figures/coolant-channel-shape-assem.png} 
        \caption{One-third assembly radius annotations.}
    \end{figure}
    \begin{figure}
        \includegraphics[width=0.49\linewidth]{../docs/figures/a-1e-temp-distribution-2d.png} 
