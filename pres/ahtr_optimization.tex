...
\begin{frame}
    ...
    \begin{block}{Varied Input Parameters}
        ...
        \end{itemize}
        Varying $PF_{total}$ and $\rho_{TRISO}(\vec{r})$ enables synergistic 
        exploration of how heterogenous TRISO distribution could minimize 
        self-shielding and thus, reduce the fuel required for a reactor design.

        Exploration of how non-uniform channel shapes impact reactor performance 
    \end{block}
