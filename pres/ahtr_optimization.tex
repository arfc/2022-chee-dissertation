...
\begin{frame}
    ...
    \begin{figure}
        \only<1>{\includegraphics[width=0.7\linewidth]{../docs/figures/ahtr-fuel-element.png}} 
        \only<2>{\includegraphics[width=0.7\linewidth]{figures/ahtr-fuel-element-annotated.png}} 
    \end{figure}
\end{frame}
...
\begin{frame}
    ...
    \begin{figure}
        \makebox[\textwidth][c]{
            \includegraphics[width=1.05\linewidth]{figures/ahtr-modeling-workflow-numbered.png}} 
