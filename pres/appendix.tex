...
\begin{frame}
    ...
    \vspace{-0.2cm}
    \begin{figure}[]
        \includegraphics[width=0.87\linewidth]{figures/grad-school-journey.png} 
    \end{figure}
\end{frame}
...
\subsection{Minimize $PPF_{fuel}$ Driving Factor Derivation}
\begin{frame}
    \frametitle{Minimize $PPF_{fuel}$ Driving Factor Derivation}
    \begin{figure}
        \only<1>{\includegraphics[width=0.8\linewidth]{figures/ppf-derivation1.png}} 
        \only<2>{\includegraphics[width=0.8\linewidth]{figures/ppf-derivation2.png}} 
        \only<3>{\includegraphics[width=0.8\linewidth]{figures/ppf-derivation3.png}} 
    \end{figure}
\end{frame}


\subsection{Simulation a-3b Hypervolume}
\begin{frame}
