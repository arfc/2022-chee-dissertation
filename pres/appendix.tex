...
\begin{frame}
    ...
    \begin{figure}
        \only<1>{\includegraphics[width=\linewidth]{figures/ppf-derivation1.png}} 
        \only<2>{\includegraphics[width=\linewidth]{figures/ppf-derivation2.png}} 
        \only<3>{\includegraphics[width=\linewidth]{figures/ppf-derivation3.png}} 
    \end{figure}
\end{frame}
