...
\begin{frame}
    ...
    \visible<2->{\begin{block}{Moltres \cite{lindsay_introduction_2018}}
        \begin{itemize}
			\item An application built on the \acrfull{MOOSE} framework, for the 
            simulation of MSRs
...
\begin{frame}
    ...
    \textbf{suitable spatial homogenization and energy discretization} to create 
    group constants and mesh that preserve accuracy while maintaining an acceptable 
    runtime.}
\end{frame}

\begin{frame}
    \frametitle{AHTR Temperature Model Energy Discretization}
        \begin{figure}[]
            \centering
...
\begin{frame}
    \frametitle{AHTR Temperature Model Spatial Homogenization}
        \textbf{Full assembly 61 cell discretization}: inter-assembly FLiBe, 
...
\begin{frame}
    ...
    comparing key neutronics parameters between: 
    \begin{itemize} 
