...
\begin{frame}
    ...
    \begin{column}{0.2\textwidth}
        \begin{figure}[]
            \centering
            \includegraphics[width=0.8\linewidth]{figures/benchmark-flux-table.png} 
            \caption{4-group flux distribution comparison.}
        \end{figure}
    \end{column}
    \end{columns}
...
\begin{frame}
    ...
    \begin{itemize}
        ...
        \item good agreement in reactivity coeffcients and 4-group neutron energy spectrum
        \item good agreement in overall flux distributions and larger 
        flux differences at specific points.
    \end{itemize}
    Takeaways 
    \begin{itemize}
        ...
        \item However, since the reactivity coefficients and overall flux distribution 
        are in agreement, OpenMC's group constants are sufficient to use to calculate
        and gain an overall perspective of the temperature distribution in the AHTR 
        model.
    \end{itemize}
    Methodology 
    \begin{itemize}
        \item I use this same Moltres model verification method for the optimized 
        AHTR designs
    \end{itemize}
\end{frame}
