...
\begin{frame}
    ...
    \end{itemize}
    KNPs: $k_{eff}$, reactivity coefficients, flux distribution, and neutron energy 
    spectrum. 
    \begin{block}{$k_{eff}$}
        \begin{table}
...
\begin{frame}
    \frametitle{AHTR Temp Model Key Neutronics Parameter Verification}
    \begin{block}{Flux Distribution}
    \begin{figure}[]
        \centering
        \includegraphics[width=0.75\linewidth]{figures/benchmark-flux.png} 
        \caption{xx}
    \end{figure}
    \end{block}
\end{frame}
...
\begin{frame}
    \frametitle{AHTR Temp Model Key Neutronics Parameter Verification}
        \begin{block}{Neutron Energy Spectrum}
            \begin{figure}[]
                \centering
                \includegraphics[width=0.8\linewidth]{figures/benchmark-spectrum.png} 
                \caption{xx}
            \end{figure}
            \end{block}
