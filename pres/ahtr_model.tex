...
\begin{frame}
    ...
    \end{itemize}
    Reactivity coefficients, flux distribution
    \begin{itemize}
        \item Ensure that Moltres accurately calculates the AHTR's temperature distribution
    \end{itemize}
\end{frame}

\begin{frame}
    \frametitle{AHTR Temp Model keff and reactivity coefficients Verification}
        \begin{table}
