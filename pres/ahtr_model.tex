...
\begin{frame}
    ...
    acceptable. I comparing key neutronics parameters (KNP) between OpenMC continuous 
    simulation and Moltres spatially and energy homogenized simulation.
    KNP: $k_{eff}$, reactivity coefficients, flux distribution, and neutron energy 
    spectrum. 
    \begin{block}{Effective Multiplication Factor}
        \begin{table}
...
% Key neutronics parameter verification? 
