...
\begin{frame}
    \frametitle{AHTR Temp Model $k_{eff}$ and Reactivity Coefficients Verification}
        ...
        \end{table}
        The 13pcm $k_{eff}$ and 6pcm reactivity difference, between
        ...
        acceptable.}
        The Moltres simulation shows a 423pcm difference in $k_{eff}$ and 216pcm 
        ...
        temperature reactivity feedback ($\frac{\Delta \pho}{\Delta T}$)
\end{frame}
