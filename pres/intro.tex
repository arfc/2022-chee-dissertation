...
\subsection{Background: Advanced High Temperature Reactor}
    \begin{frame}
        ...
        \begin{figure}[]
            \makebox[\textwidth][c]{
                \includegraphics[width=1.15\linewidth]{figures/fhr_venn.png}} 
        ...
        \begin{column}{0.5\textwidth}
            ...
            \vspace{0.2cm}
            \acrfull{TRISO} fuel: fuel kernel encapsulated in three layers of 
            carbon and ceramic-based materials, \textbf{higher safety margin, 
            extra barriers to fission product release}. 

            \begin{figure}[htbp!]
                \includegraphics[width=0.33\linewidth]{../docs/figures/ahtr-triso.png}
...
\begin{frame}
    ...
    parameters}. 
    \begin{figure}[]
        \includegraphics[width=0.4\linewidth]{figures/tungsten-wavy-channels.png}
        \caption{3D printed wavy flow channels, reproduced from the NASA's Refractory 
        Alloy Additive Manufacturing Build Optimization Project (RAAMBO) 
        \cite{mireles_refractory_2022}.}
    \end{figure}
    Wide-spread adoption of 3D printing for nuclear reactor parts could reduce reactor 
