...
\end{frame}
  ...
  \begin{frame}
    ...
    \vspace{0.2cm}
    \visible<2->{The generative design software \textbf{automates the search process for suitable 
    geometries}. 
    ...
    \vspace{0.2cm}
    \visible<3->{\textbf{Evolutionary algorithms} can be used to \textbf{drive generative reactor 
