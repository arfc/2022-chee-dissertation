...
\end{frame}
  ...
  \begin{frame}
    ...
    \vspace{0.2cm}
    The generative design software \textbf{automates the search process for suitable 
    geometries}. 

    Human reactor designer can instead focus on 
    \begin{itemize}
        \item Defining design criteria for optimal designs 
        \item Evaluating the results generated by generative design software  
    \end{itemize}
  ...
  \end{frame}
    ...
    \begin{minipage}[c]{0.49\textwidth}
        \begin{figure}
            \includegraphics[width=0.9\linewidth]{figures/ea-flow.png} 
