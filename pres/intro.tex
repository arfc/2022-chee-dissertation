...
\end{frame}
  ...
  \end{frame}
    ...
    \begin{minipage}{0.49\textwidth}
        ...
        \begin{itemize}
            \item Imitate natural selection to evolve solutions 
            \item Set of solutions improve with every generation 
        \end{itemize}
        %\textbf{Evolutionary algorithms imitate \\ natural selection} to evolve 
        %solutions, and with every generation \textbf{the average population improves}. 
