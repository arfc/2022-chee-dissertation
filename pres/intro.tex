...
\begin{frame}
    ...
    parameters}. 
    \begin{figure}[]
        \includegraphics[width=0.2\linewidth]{figures/tungsten-wavy-channels.png}
    ...
    \end{figure}
    Wide-spread adoption of 3D printing for nuclear reactor parts could
    \begin{itemize}
        \item reduce reactor fabrication costs 
        \item reduce deployment timelines 
        \item improve reactor safety and performance
    \end{itemize}
    \vspace{0.2cm}
