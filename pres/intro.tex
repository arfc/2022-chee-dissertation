...
\begin{frame}
    ...
    \visible<3->{Wide-spread adoption of 3D printing for reactor parts could \textbf{reduce 
    fabrication costs and deployment timelines, and improve reactor safety and 
    performance}.}

    \vspace{0.1cm}
    \visible<4->{To explore the new design space enabled by 3D printing more 
    fficiently, we require methods, such as \textbf{generative design}.}
\end{frame}
