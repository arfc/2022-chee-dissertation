...
\subsection{Background: Advanced High Temperature Reactor}
    ...
    \begin{itemize}
        \visible<2->{\item Many surfaces to model = computationally expensive} 
        \visible<3->{\item Homogenization might result in loss of reactor physics effects} 
    \end{itemize}
    \vspace{0.3cm}
    \visible<4->{In 2019 the \textbf{OECD-NEA initiated the FHR benchmark}. Its objective 
