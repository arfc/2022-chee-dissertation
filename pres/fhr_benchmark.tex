...
\begin{frame}
    ...
    \begin{columns}
        ...
        \begin{column}{0.5\textwidth}
            \textbf{Key Takeaways} 
            \begin{itemize}
                \visible<2->{\item Peak in Group 1 fast neutrons born in assembly diamond's 
                center} 
                \visible<3->{\item Fast neutrons are moderated in graphite matrix and structure} 
                \visible<4->{\item Outer diamond's sides absorb the moderated thermal neutrons and 
