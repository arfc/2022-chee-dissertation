...
\begin{frame}
    ...
    \begin{columns}
        \begin{column}{0.5\textwidth}
            \begin{figure}
                \centering 
                \only<1>{\includegraphics[width=0.95\linewidth]{figures/phase1a-flux-vert.png}}
                \only<2>{\includegraphics[width=0.95\linewidth]{figures/phase1a-flux-vert-annotated1.png}}
                \only<3>{\includegraphics[width=0.95\linewidth]{figures/phase1a-flux-vert-annotated2.png}}
                \only<4>{\includegraphics[width=0.95\linewidth]{figures/phase1a-flux-vert-annotated3.png}}
                \only<5>{\includegraphics[width=0.95\linewidth]{figures/phase1a-flux-vert-annotated4.png}}
                \only<6>{\includegraphics[width=0.95\linewidth]{figures/phase1a-flux-vert-annotated5.png}}
                \vspace{-0.4cm}
        ...
        \begin{column}{0.5\textwidth}
            ...
            \begin{itemize}
                ...
                \visible<5->{\item Results in a dip in thermal Group 3 flux in the 
                assembly diamond's center}
                \visible<6->{\item This \textbf{self-shielding effect is more pronounced 
                in Case 6A}} 
            \end{itemize}
        \end{column}
    \end{columns}
