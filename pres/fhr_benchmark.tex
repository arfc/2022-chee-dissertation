...
\begin{frame}
    ...
    \begin{figure}[]
        \centering
        \includegraphics[width=0.32\linewidth]{../docs/figures/p1a_c1a_e_eg1.png} 
        \includegraphics[width=0.32\linewidth]{../docs/figures/p1a_c1a_e_eg2.png} 
        \includegraphics[width=0.32\linewidth]{../docs/figures/p1a_c1a_e_eg3.png} 
        \includegraphics[width=0.32\linewidth]{../docs/figures/p1a_6a_e_eg1.png} 
        \includegraphics[width=0.32\linewidth]{../docs/figures/p1a_6a_e_eg2.png} 
        \includegraphics[width=0.32\linewidth]{../docs/figures/p1a_6a_e_eg3.png} 
        \vspace{-0.2cm}
