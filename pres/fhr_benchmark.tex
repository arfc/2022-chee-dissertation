...
\begin{frame}
    ...
    \begin{columns}
        ...
        \begin{column}{0.5\textwidth}
            \textbf{Key Takeaways} 
            \begin{itemize}
                \item Peak in Group 1 fast neutrons born in assembly diamond's center. 
                Fast neutrons are moderated in graphite matrix and structure 
                \item Outer sides absorb the moderated thermal neutrons and 
