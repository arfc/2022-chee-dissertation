...
\gls{FHR} use \gls{TRISO} fuel and a low-pressure liquid fluoride-salt coolant.
...
1200K, with reflective boundary conditions. 
...
\begin{figure}[htbp]
    ...
    The mesh files are used in the \gls{AHTR} assembly's Moltres temperature models.}
...
1025K, while the graphite structure has a average temperature of approximately 935K. 
The \gls{FLiBe} coolant channel (inter-plank, inter-assembly, control rod slot) regions 
remain at 923K, as defined in the temperature model setup. 
The temperature peaks at 1062K and occur in the fuel stripes near the spacers. 
...
The multiphysics model demonstrates the temperature distribution in the \gls{AHTR} peaks 
in the fuel stripes near the spacers. 
