...
reactivity coefficients, flux distribution, and neutron energy spectrum for the OpenMC's 
continuous energy and Moltres' \gls{FHR} benchmark full assembly model. 
