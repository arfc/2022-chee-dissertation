...
I defined the \gls{AHTR} input parameters for optimization problems: 
\acrfull{TRISO} packing distribution, total fuel packing fraction and coolant 
channel shape. 
I also defined the key optimization objectives: minimizing fuel amount,
...
The following two chapters: \gls{AHTR} plank optimization results and \gls{AHTR} 
one-third assembly optimization results, use the methods described. 