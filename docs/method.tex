...
distributions to govern the \gls{TRISO} particle packing fraction distribution. 
...
\end{figure}
Thus, \gls{ROLLO} will vary $radius_{top}$ and $radius_{bot}$ to find optimal coolant 
channel shapes.
