...
During the optimization simulations in which I vary the $PF_{total}$, I assume power 
remains constant. 
...
optimization problem objectives (described in Table \ref{tab:objectives})l that is, 
