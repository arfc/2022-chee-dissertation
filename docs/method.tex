...
\begin{figure}[htbp]
    ...
    \begin{tikzpicture}[node distance=0.5cm]
        ...
        \node (2) [g72block, right=of 1] {$PF_{total}$};
        \node (3) [e82block, above=of 2] {Independent Variables};
        \node (5) [g72block, right=of 4] {$\rho_{TRISO}(\vec{r})$};
        \node (7) [g72block, right=of 6] {\textit{Coolant Channel Shape}};
    ...
    with ROLLO selecting the independent variables. 
