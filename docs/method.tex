...
After the transport simulation is complete, a separate OpenMC output file analyzes 
the OpenMC model's output and calculates the $k_{eff}$ constraint and the 
