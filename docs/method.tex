...
Comparisons of the effective multiplication factor and neutron energy spectrum are 
to verify that the Moltres model is replicating the OpenMC model's neutronics correctly.
Comparison of the reactivity coefficients and flux distributions produced by Moltres
and OpenMC are key to ensuring that Moltres accurately calculates the \gls{AHTR}'s 
...
% TODO: why start w keff, lead your readers,,, 
...
\begin{table}[htbp]
    ...
    \end{tabular}
\end{table}
% TODO: instead of difference, report reactivity difference... 

The 50pcm $k_{eff}$ and 35pcm reactivity difference, that can be observed in Table 
...
are acceptable. 
However, there is a 706 pcm difference in the Moltres simulation's $k_{eff}$ and 
...
% does keff diff affect temperature...? 

\subsubsection{AHTR Plank: Reactivity Coefficients}
% TODO: add intro... why compare these? What do you want to learn by doing this? 
% reactivity coefficients: accurately capture temperature reactivity feedback 
% The effect of temperature reactivity feedback on the flux when the temperature 
% varies with space as opposed to uniform temperature distributions in the 
% openmc models. 
%TODO: ask SM
...
\begin{table}[htbp]
    ...
    \end{tabular}
\end{table}
% comment more about reactivity vs keff disagreement. What does this mean for your 
%study?  
%TODO: ask SM
...
% verifying the Moltres model is accurate 
