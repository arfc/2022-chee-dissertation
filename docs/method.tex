...
\begin{figure}[htbp]
    ...
    in 4 groups at 948K. Comparison between OpenMC simulation with continuous energy 
...
simulation for both 252 and 4 groups, and 4-group Moltres simulation. 
 \begin{figure}[htbp]
    ...
    \caption{\acrfull{AHTR} plank's neutron spectrum for OpenMC simulation with 
    continuous energy and TRISO-level spatial fidelity for 252 and 4 groups, and 
    Moltres simulation with 4-group energy and spatial homogenization for 4 groups.}  
