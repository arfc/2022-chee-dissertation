...
The \gls{ROLLO} optimization simulation with the most-optimized hyperparameter 
set's resulting \gls{AHTR} plank model with the highest $k_{eff}$ value is used for 
this verification study. 
The \gls{AHTR} plank model has a $PF_{total} = 0.0979$ and 
...
\end{figure}
% TODO: Why did i pick this model. 
% i picked it because it was one of the optimized cases... 

\subsubsection{AHTR Plank: Effective Multiplication Factor}
% TODO: why start w keff, lead your readers,,, 
%The absolute value of $k_{eff}$ impacts the final steady-state temperature of the
%reactor \cite{park_advancement_2020}. 
%TODO: ask SM
...
\begin{table}[htbp]
    ...
    \end{tabular}
\end{table}
% instead of difference, report reactivity difference... 
