...
\begin{align}
    ...
    - \nabla \cdot (k_i \nabla T) &= Q_i
\intertext{where}
k_i &= \mbox{thermal conductivity of material i } [W \cdot cm^{-1} \cdot K^{-1}] \nonumber \\
T &= \mbox{temperature in the model } [K] \nonumber \\
Q_i &= \mbox{source or sink term in material i } [W \cdot cm^{-2}] \nonumber
\end{align} 
...
\intertext{where} 
Q_f &= \mbox{source term } [MeV \cdot cm^{-3} \cdot s^{-1}] \nonumber \\
...
\phi_g &= \mbox{flux of neutrons in group g } [n \cdot cm^{-2} \cdot s^{-1}]\nonumber
\end{align}
