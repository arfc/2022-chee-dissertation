...
To ensure that the geometry mesh input to the \gls{AHTR} plank Moltres temperature model is 
sufficiently converged, I performed a mesh refinement study, outlined in Table 
\ref{tab:ahtr-plank-mesh-refinement}. 
\begin{table}[htbp]
    \centering
    \onehalfspacing
    ...
    \end{tabular}
\end{table}
I used x3 mesh refinement for all AHTR Plank Moltres temperature models. 

\subsection{AHTR One-Third Assembly: Mesh Refinement Study}
To ensure that the geometry mesh input to the \gls{AHTR} one-third assembly Moltres temperature 
model is sufficiently converged, I performed a mesh refinement study, outlined in Table 
\ref{tab:ahtr-assem-mesh-refinement}. 
\begin{table}[htbp]
    \centering
    \onehalfspacing
    ...
    \end{tabular}
\end{table}
I used x4 mesh refinement for all \gls{AHTR} one-third assembly Moltres temperature 
models. 
...
\subsection{AHTR One-Third Assembly: Group Constant Temperature Study}
