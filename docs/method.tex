...
In the following sub-sections, I describe the \gls{AHTR} modeling workflow: from the 
AHTR geometry variation input parameters, to the OpenMC and Moltres models, 
and finally the calculation of output and constraint values. 
