...
% TODO: update after assem's coolant is defined
...
Figures \ref{fig:ahtr-plank-geo} and \ref{fig:ahtr-assem-geo} show a Gmsh rendered 
geometry file example generated by the geometry script files for the AHTR plank 
