...
The delayed neutron fraction, $\beta$, and reactivity coefficients, $\alpha$ are 
indicators of transient reactor behavior in an accident transient. 
...
magnitude of change in reactor power and temperature \cite{park_advancement_2020}.
%TODO: ask SM
