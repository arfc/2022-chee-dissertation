...
\begin{figure}[htbp]
    ...
    \begin{tikzpicture}[node distance=0.5cm]
        ...
        \node (15) [g72block, below=of 14] {$PF_{total}$};
...
The normalization factor normalizes each fuel cell to ensure that the total volume of 
TRISO particles in the plank corresponds to $PF_{total}$.
...
The normalization factor normalizes each fuel cell to ensure that the total volume of 
TRISO particles in the one-third assembly corresponds to $PF_{total}$.
...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=\linewidth]{hyperparameter_sens.png}
...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=\linewidth]{input_hyperparameters_sens.png}
