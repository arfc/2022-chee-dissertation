...
\begin{table}[htbp]
    ...
    \end{tabular}
\end{table}
% TODO: Motivation (talk to Madicken)
% minimize thermal stress in the fuel. Lowering max temp, means gradient is smaller, at 
% the same power
...
For this verification study, I selected to use an \gls{AHTR} plank model with a 
