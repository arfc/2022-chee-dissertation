...
In the following figures, I ran each simulation 25 times to produce each box plot. 

Figure \ref{fig:hypervolume-comparison-gens} shows a boxplot comparing hypervolume 
...
For each population size - generation pair in Figure \ref{fig:hypervolume-comparison-gens}, 
