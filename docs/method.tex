...
\begin{align}
    ...
    b &= \mbox{angular frequency, rate of change of the function argument } [radians cm^{-1}] \nonumber \\
...
Thus, \gls{ROLLO} will vary \textit{a, b, c} variables to find an optimal TRISO particle 
sine distribution. 
