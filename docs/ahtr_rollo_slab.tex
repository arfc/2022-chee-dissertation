...
hypervolume. 
The convergence criteria is ... %TODO hypervolume must get larger, and if there is a 
% small difference between hypervolume values in consecutive generations, 
% means its probably almost converged. However, I am balancing computational cost and 
% convergence... 
...
\begin{table}[htbp!]
    ...
    \end{tabular}
\end{table}
% TODO: comment why this isn't in the range max of the previous section of 0.02 to 0.04
...
% TODO: remind us of convergence criteria and that D 2-> 3 is smaller. 
\begin{table}[htbp!]
    \centering
    \onehalfspacing
...
\gls{ROLLO} successfully found widely spread solutions in each of the two-objective 
