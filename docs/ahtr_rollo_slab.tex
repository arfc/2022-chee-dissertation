...
\begin{figure}[htbp!]
    ...
    \begin{subfigure}{\textwidth}
        ...
        \ref{fig:slab-obj-2-pfppf-pareto-distr}).}
        \label{slab-obj-2-pfppf-min-ppf} 
    \end{subfigure}
...
(also illustrated in Figure \ref{slab-obj-2-pfppf-min-pf}). 
In Figure \ref{fig:slab-obj-2-pfppf-pareto-distr}, the TRISO distribution with the 
...
and both sides (also illustrated in Figure \ref{slab-obj-2-pfppf-min-ppf}). 
...
\begin{figure}[htbp!]
    ...
    \begin{subfigure}{\textwidth}
        ...
        \label{slab-obj-2-tempppf-min-temp} 
    \end{subfigure}
    \begin{subfigure}{\textwidth}
        ...
        \ref{fig:slab-obj-2-tempppf-pareto-distr}).}
        \label{slab-obj-2-tempppf-min-ppf} 
    \end{subfigure}
