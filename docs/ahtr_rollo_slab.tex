...
$PF_{total} = 0.026$, $r_{top}=0.273cm$, and $r_{top}=0.232cm$ (the corresponding geometry 
...
TRISO distribution of $PF_{total}=0.034$, $r_{top}=0.327cm$, and $r_{top}=0.33cm$
...
$r_{top}=0.245cm$ (the corresponding geometry is illustrated in Figure 
...
and $r_{top}=0.33cm$ (reactor model 3 with the green dashed distribution in Figure 
...
$PF_{total} = 0.026$, $r_{top}=0.273cm$, and $r_{top}=0.232cm$ (reactor model 21 
