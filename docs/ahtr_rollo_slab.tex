...
\begin{figure}[htbp!]
    \centering
    \includegraphics[width=\linewidth]{p-2a-p-1a-pf-most-minimized-comparison.png} 
...
\begin{figure}[htbp!]
    \centering
    \includegraphics[width=\linewidth]{p-2a-p-1b-temp-most-minimized-comparison.png} 
...
\begin{figure}[htbp!]
    \centering
    \includegraphics[width=\linewidth]{p-2b-p-1a-pf-most-minimized-comparison.png} 
...
\begin{figure}[htbp!]
    \centering
    \includegraphics[width=\linewidth]{p-2b-p-1c-ppf-most-minimized-comparison.png} 
...
p-1a's most-minimized $PPF_{fuel}$ TRISO distribution which has a large $\sim 0.07$ 
