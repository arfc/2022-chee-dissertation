...
Moltres' governing equation for temperature was described in Equation 
\ref{eq:moltres-temp}.
In the AHTR Steady-State Temperature Model, the time-dependent and velocity-dependent 
terms cancel out since I am solving for steady-state and there is no moving fuel. 
...
A convective heat exchanger term models the heat removal from the AHTR fuel slab 
in the coolant areas: 
\begin{align}
