...
\begin{figure}[htbp!]
    \ContinuedFloat
    \begin{subfigure}{\textwidth}
        \includegraphics[width=\linewidth]{slab-obj-2-ppf-min-pf.png}
        \caption{\gls{AHTR} plank model with most-minimized total fuel packing fraction
        (corresponds to the orange bolded distribution in Figure 
        \ref{fig:slab-obj-2-pfppf-pareto-distr}).}
        \label{slab-obj-2-ppf-min-pf} 
    \end{subfigure}
    \begin{subfigure}{\textwidth}
        \includegraphics[width=\linewidth]{slab-obj-2-ppf-min-ppf.png}
...
(also illustrated in Figure \ref{slab-obj-2-ppf-min-pf}). 
In Figure \ref{fig:slab-obj-2-pfppf-pareto-distr}, the TRISO distribution with the 
...
and both sides (also illustrated in Figure \ref{slab-obj-2-ppf-min-ppf}). 
