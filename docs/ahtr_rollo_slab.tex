...
I varied the TRISO particle distribution while constraining $k_{eff} >= 1.34$
and holding total packing fraction at 0.0979.
Figure \ref{fig:slab-obj-2-tempppf-pareto} shows a plot of maximum temperature 
against normalized power peaking factor for all the individual reactor models 
