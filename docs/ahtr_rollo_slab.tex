...
In Figure \ref{fig:slab-obj-2-tempppf-pareto}, \gls{ROLLO} finds six widely spread 
...
Pareto front have approximately $\sim0.1$ of variation. 
...
distribution (also illustrated in Figure \ref{fig:slab-obj-3-min-pf}).
In Figure \ref{fig:slab-obj-3-distr-most-minimized}, the TRISO distribution with the 
