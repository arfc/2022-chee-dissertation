...
\begin{table}[htbp]
    ...
    & $0.05<r_{bot}<0.35$ \\
    \hline
    \textbf{Constraints} & $k_{eff} \leq 1.36$\\ 
    \hline 
...
\begin{table}[htbp]
    ...
    \end{tabular}
\end{table}
Figure \ref{fig:slab-obj-1-temp-evol-coolant} shows the maximum plank temperature evolution 
and Figure \ref{fig:slab-obj-1-temp-final-coolant} shows a plot of total radius 
($r_{top} + r_{bot}$) against maximum plank temperature. 
\begin{figure}[htbp]
    \centering
    \begin{subfigure}{\textwidth}
