...
center and both sides with a $\sim0.02$ TRISO spatial variation, which differs 
from simulation p-1c's most-minimized $PPF_{fuel}$ TRISO distribution which has a 
