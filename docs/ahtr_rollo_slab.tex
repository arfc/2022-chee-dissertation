...
The FliBe molten salt is at an initial temperature of 923K, reflecting the AHTR's 
inlet temperature. %cite ahtr 923K inlet temp 
...
\intertext{where:}
h &= \mbox{heat transfer coefficient } [\frac{W}{m^2K}] \nonumber \\
