...
I varied the TRISO particle distribution while constraining $k_{eff} >= 1.35$
...
fraction is has a constant packing fraction of 0.02 across the slab. 
...
% see pf_ppf_analysis_update.ipynb for plots. 
