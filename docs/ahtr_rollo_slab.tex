...
Section \ref{sec:plank-compute-cost} details each optimization simulation's compute time.  
...
For the multi-objective optimization problems, the most optimal solutions are on the 
Pareto front. 
...
Thus, for the multi-objective optimization problem results in this section and Section 
\ref{sec:plank-three-obj}, I report on the optimal reactor models on the Pareto front. 
...
Table \ref{tab:plank-compute-cost} reports the compute time used for each optimization 
problem. 
