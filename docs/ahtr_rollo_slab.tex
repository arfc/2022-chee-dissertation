...
\label{sec:p-3a}
This section reports results from the three-objective optimization simulation p-3a, the 
objectives minimized are total fuel packing fraction ($PF_{total}$), maximum plank 
