...
\begin{figure}[htbp!]
    \centering
    \includegraphics[width=0.49\linewidth]{p-2a-p-1a-pf-most-minimized-comparison.png} 
    \caption{Simulation p-2a's most-minimized $PF_{total}$ TRISO distribution 
    from Figure \ref{fig:slab-obj-2-pftemp-pareto-distr} and simulation p-1a's 
