...
By the $9_{th}$ generation, the average, minimum, and maximum packing fraction
values have converged to approximately 0.023. 
...
\end{figure}
The minimum and average slab maximum temperature converged to approximately 
1125 K. 
In figure \ref{fig:slab-obj-1-temp-final}, I observe that a somewhat flat TRISO 
