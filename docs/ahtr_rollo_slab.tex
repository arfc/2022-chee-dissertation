...
variations in the TRISO distribution minimizes $T_{max}$ by 60K, thus, having a higher 
impact on the $T_{max}$ value compared to coolant channel variation. 
% How do these relative importances inform future design choices. 
