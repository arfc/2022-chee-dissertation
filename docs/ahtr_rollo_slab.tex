...
\end{figure}
The minimum and average plank's maximum temperature converged to approximately 
1125 K. 
...
Figure \ref{fig:slab-obj-1-temp-distr} compares the Moltres-generated temperature distribution 
for the plank with mostly flat (figure \ref{fig:slab-obj-1-temp-final}) and 
flat TRISO particle distributions for the same total packing fraction.
\begin{figure}[]
    \centering
