...
I conduct two-objective optimizations for varying total fuel packing 
fraction ($PF_{total}$) and \gls{TRISO} packing fraction distribution 
($\rho_{TRISO}(\vec{r})$). 
Section \ref{sec:plank-overview}'s Table \ref{tab:slab-obj-breakdown} summarized 
the two-objective simulations in this section: p-2a, p-2b, and p-2c.
...
Section \ref{sec:binhandkorn} describes how the reference point value and 
