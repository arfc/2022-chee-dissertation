...
Facility under the Director's Discretionary Allocation Program 
\cite{noauthor_argonne_2022}. 
Each optimization problem takes a different amount of compute time to run due to 
differences in simulation software, tallies and intermediate steps required. 

Table \ref{tab:plank-compute-time} reports the compute time used for each optimization 
problem. 
