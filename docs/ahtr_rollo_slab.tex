...
\label{sec:p-2b}
% TODO: something that would be nice would be to explain why this combination of 
% optimized parameters might be good in a design. Do you expect lowering PF 
% to increase PPF? Why do both at once? 
