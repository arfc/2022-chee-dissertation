...
\gls{FHR} benchmark's $PF_{total}$, and constrained $k_{eff} \geq 1.00$. 
This $PF_{total}$ is higher than the $PF_{total}$ variation utilized in simulation p-1a 
of 0.02 to 0.04. 
During the preliminary work, I observed that the TRISO spatial variation enabled 
comparable $k_{eff}$ values with lower $PF_{total}$ values. 
