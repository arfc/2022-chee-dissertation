...
$PPF_{fuel}$.
This explains why for simulation p-2b, \gls{ROLLO} found that a constant TRISO 
distribution with $PF_{total} = 0.02$, most-minimized $PF_{total}$ instead of 
an oscillating TRISO distribution due to influences from the minimize $PPF_{fuel}$ 
objective. 
