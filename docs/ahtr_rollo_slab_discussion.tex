...
In the multi-objective optimization simulations, the minimize $T_{max}$ objective continues 
to influence the flattening of the TRISO distribution and maximizing of the coolant 
channel shape's $r_{tot}$ to achieve the objective. 
The results from simulation p-2b and investigations in Section 
\ref{sec:plank-discussion-ppf-results} suggest that the minimize $PF_{total}$ 
objective's driving force maximize total fission reaction rate and 
minimize $PPF_{fuel}$ objective's driving force flattening thermal flux distribution 
...
Figure \ref{fig:slab-obj-3-all} shows the 21 widely spread reactor models on simulation 
p-3b's Pareto front. 
% talk about how reactor designers can use this info 
