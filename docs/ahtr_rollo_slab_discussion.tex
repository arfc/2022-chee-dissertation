...
$\sim0.15$ variation and $PF_{total}=0.02$, most-minimized $PF_{total}$ 
...
In Section \ref{sec:plank-discussion-pf}, I concluded that the oscillating TRISO 
distribution enabled a lower packing fraction for the same $k_{eff}$ as it enabled 
higher fission reaction rates in the \gls{AHTR} plank. 
