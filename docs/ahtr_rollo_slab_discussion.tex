...
TRISO distribution and maximizes coolant channel shape's $r_{tot}$ to achieve the objective. 
...
parameter. 
I found that the minimize $T_{max}$ is driven by minimizing plank's maximum temperature; 
