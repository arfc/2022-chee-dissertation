...
reaction rates to enable a reactor model with a lower $PF_{total}$ that meets $k_{eff}$ 
constraints. 
...
and $k_{eff}$ values within error of each other despite reactor model 11 having a lower 
$PF_{total}$ ($PF_{total, 11}=0.0566$ vs. $PF_{total, 5}=0.0591$).
Reactor model 11's oscillating TRISO distribution enables a comparable $k_{eff}$, 
for a lower $PF_{total}$ compared to reactor model 5 because 
