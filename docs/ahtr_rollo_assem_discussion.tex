...
constant $PF=0.05$ TRISO distribution, the temperature peaks in top and bottom 
graphite planks. 
...
Figures \ref{fig:assem-obj-1-temp-evol} and \ref{fig:assem-obj-1-temp-evol-coolant} 
...
\begin{table}[htbp!]
    ...
    \footnotesize
    \begin{tabular}{p{3cm}p{1.5cm}p{2.3cm}p{4cm}p{2.5cm}l}
    \hline
    \textbf{Most Minimized Param} & \textbf{Reactor Model} 
    & \textbf{Fission Rxn Rate} & \textbf{$\%$ Diff}
