...
\begin{table}[htbp!]
    ...
    \footnotesize
    \begin{tabular}{p{3cm}p{1.5cm}llp{3cm}p{3cm}p{3cm}}
    \hline
    & \textbf{Reactor Model} & \textbf{$PF_{total}$} & \textbf{$PPF_{fuel}$} & \textbf{TRISO distribution variance} & \textbf{Fission Reaction Rate} & $max(\phi_4)/min(\phi_4)$\\
    \hline 
