...
$T_{max}$ peaks in the 1st graphite plank (at 3.52cm) but has an unexpectedly small 
$r_5 = 0.13cm$.
...
This paired with simulation a-3b's 128 individuals per generation possibily being  
