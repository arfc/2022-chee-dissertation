...
Chapter \ref{chap:ahtr-plank-opt-results} concluded that the minimize $PF_{total}$ 
objective is driven by maximizing the plank's total fission reaction rate and 
the minimize $PPF_{fuel}$ objective is driven by flattening the plank's thermal flux
distribution. 
This section compares the total fission reaction rate and thermal flux flattness for 
3 reactors models on Figure \ref{fig:assem-obj-2-pfppf-pareto}'s Pareto Front: 
