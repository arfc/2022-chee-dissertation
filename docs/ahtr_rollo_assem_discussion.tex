...
I determined that \gls{ROLLO} flattens TRISO distribution and maximizes the FLiBe 
channels radius values ($r_1, r_2, r_3, r_4, r_5$) that are close to the reactor model's 
temperature peak to achieve the minimize $T_{max}$ objective. 
...
search of the large reactor design space, to find optimal reactor models that satisfy 
all the objectives. 
