...
$r_1$ and $r_5$ control the coolant channel shape of the \gls{FLiBe} channels next 
to the top and bottom graphite planks. 
Therefore, to minimize maximum one-third assembly temperature, maximizing $r_1$ and 
$r_5$ enables enhanced cooling in the top and bottom graphite planks. 
