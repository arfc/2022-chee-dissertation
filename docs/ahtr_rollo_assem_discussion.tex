...
Figure \ref{fig:a-1c-ppf-triso-comparison} shows the TRISO distributions and the $PPF_{fuel}$ 
...
the maximum $PPF_{fuel}$ TRISO distribution. 
%\begin{figure}[htbp!]
%    \centering
%    \includegraphics[width=0.9\linewidth]{a-1c-ppf-triso-comparison-most-minimized.png} 
%    \includegraphics[width=0.9\linewidth]{a-1c-ppf-triso-comparison-least-minimized.png} 
%    \caption{Simulation a-1c's most-minimized $PPF_{fuel}$ TRISO distribution 
%    from Figure \ref{fig:slab-obj-1-ppf} and the maximum $PPF_{fuel}$ TRISO distribution.}
