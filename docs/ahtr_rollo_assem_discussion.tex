...
Reactor model 3 most-minimized the $PF_{total}$ objective, and has a similar TRISO 
distribution to simulation a-1a's most-minimized $PF_{total}$ TRISO distribution 
(Figure \ref{fig:assem-obj-1-pf-final}). 
They have comparable packing fraction deviation of 0.032 and 0.04. 
Reactor model 1 most-minimized the $PPF_{fuel}$ objective,
