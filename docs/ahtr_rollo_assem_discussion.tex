...
In simulation a-2a, \gls{ROLLO} found that reactor models 3 and 4 (Figure 
\ref{fig:assem-obj-2-pftemp-pareto-distr}) most-minimized the $PF_{total}$ objective, 
and have an oscillating TRISO distribution along the both the x-axis and y-axis. 
