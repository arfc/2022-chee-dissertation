...
$PF_{total}$.
Reactor model 11 has a higher fission reaction rate compared to reactor model 5 despite 
reactor model 11 having a lower $PF_{total}$ ($PF_{total}=0.0566$ vs. 
$PF_{total}=0.0591$).
Reactor model 11's oscillating TRISO distribution enables a higher fission reaction rate, 
