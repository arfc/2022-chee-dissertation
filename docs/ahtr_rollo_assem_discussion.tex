...
Figure \ref{fig:a-2a-pf-triso-comparison} compares simulation a-2a's reactor model 3 and simulation 
a-1a's most-minimized $PF_{total}$ reactor model. 
\begin{figure}[htbp!]
    \centering
    ...
    from Figure xx (left) and simulation a-1a's most-minimized $PF_{total}$ TRISO 
    distribution from Figure \ref{fig:assem-obj-1-pf} (right).}
    \label{fig:a-2a-pf-triso-comparison}
\end{figure}
These distributions are similar to simulation a-1a's most-minimized $PF_{total}$ TRISO 
