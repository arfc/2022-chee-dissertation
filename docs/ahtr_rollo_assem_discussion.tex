...
\gls{ROLLO} found 12 widely spread reactor models on simulation a-3b's Pareto 
...
However, they have different $PF_{total}$ values, and simulation a-3b's most-minimized 
$T_{max}$'s TRISO distribution is not as flat as simulation a-1b. 
