...
\end{figure}
Figure \ref{fig:a-2a-pf-triso-comparison} shows that simulation a-2a's reactor model 3 
and simulation a-1a's most-minimized $PF_{total}$ reactor model have similar 
distributions with peaks on the even fuel cell columns. 
...
% explain this with the weird r/s between PF and PPF. 
