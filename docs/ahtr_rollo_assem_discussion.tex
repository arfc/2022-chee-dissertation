...
the \gls{AHTR} one-third assembly model's reactor optimization objective driving 
factors are the same as the \gls{AHTR} plank model (Section \ref{sec:plank-discussion}). 
I also analyzed how the reactor optimization objectives combined effects result in the 
...
maximum temperature; it flattens TRISO distribution and maximizes the radius values 
...
distribution and influences $PF_{total}$ and oscillations in the TRISO disribution 
...
simulation a-3b-256 final generation's Pareto front. 
