...
Figure \ref{fig:assem-obj-3-3d} shows a plot of the final generation's reactor models' 
$PF_{total}$ against $T_{max}$ against $PPF_{fuel}$; crosses mark the reactor models 
that fall on the Pareto front.
Figure \ref{fig:assem-obj-3-distr} shows the xx TRISO packing fraction distributions in 
...
Figure \ref{fig:assem-obj-3} demonstrates that \gls{ROLLO} found xx reactor models on 
...
,reactor model 1 most-minimized $PPF_{fuel}$, and reactor model xx equally minimized 
