...
x-axis and y-axis, and a packing fraction standard deviation of $0.04$. 
On the x-axis, the distribution peaks on the even fuel cell columns (at 8.2cm, 12.3cm, 
16.4cm, 20.5cm, and 24.5cm). 
The even columns have the largest x-axis variation of $\sim0.05$ and the odd columns 
have the smallest x-axis variation of $\sim0.01$.
On the y-axis, the distribution peaks on the 2nd and 5th fuel cell rows (at 6.8cm and 
16.5cm).
The 2nd and 5th row have the largest y-axis variation of $\sim0.10$ and the middle 3rd 
and 4th rows have the smallest y-axis variation of $\sim0.06$.
...
most-minimized $T_{max}$ has a $T_{max}=1180.3$K and an almost constant TRISO packing fraction
distribution.
...
peaks of $\sim0.08$ on the x-axis at the 8.2cm, 14.3cm, and 22.5cm, and minimums of 
$\sim0.04$ on the x-axis at 12.3cm and 18.4cm. 
...
and 24.5cm) and has minimum points at 2nd, 3rd, and 8th columns (at 8.2cm, 10.3cm, 
and 20.5cm).
The maximum $\sim0.088$ y-axis variation occurs on the fifth column (at 14.3cm), and the 
average y-axis variation is $\sim0.055$.
...
The maximum $\sim0.09$ x-axis variation occurs in the bottom row (at 3.5cm), and 
the average x-axis variation is $\sim0.065$. 
...
x-axis and y-axis. 
On the x-axis, the distribution peaks at 8.2cm, 14.3cm, and 20.5cm. 
...
The x-axis variations are $\sim0.015$ and the y-axis variations are $\sim0.03$.
...
On the x-axis, the distribution peaks at 6.2cm, 14.3cm, and 20.5cm. 
On the y-axis, the distribution peaks at 6.8cm and 13.3cm. 
The maximum $\sim0.063$ x-axis variation occurs in the 3rd row (at 13.3cm), and 
the average x-axis variation is $\sim0.058$. 
The maximum $\sim0.015$ y-axis occurs on the eighth column (at 20.5cm), and the average
y-axis variation is $\sim0.009$.
...
Figure \ref{fig:assem-obj-2-tempppf-pareto} shows that the minimize $T_{max}$ and minimize 
$PPF_{fuel}$ objectives are noncontradictory, resulting in a single reactor model on the 
Pareto Front. 
The TRISO distribution shown in Figure \ref{fig:assem-obj-2-tempppf-pareto-distr} best 
minimizes both $T_{max}$ and $PPF_{fuel}$. 
The reactor model has an oscillating TRISO distribution along the both the x-axis and y-axis 
with a higher variance along the y-axis compared to the x-axis. 
The maximum x-axis packing fractions occur at 22.5cm, and the average x-axis variation is 
$\sim0.003$. 
The maximum y-axis packing fractions occurs at 3.5cm, 10.0cm, and 16.5cm, and the average
y-axis variation is $\sim0.006$.
