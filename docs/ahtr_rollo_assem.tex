...
peaks of $PF\approx xx$. 
The 3rd row has the smallest x-axis variation of $\sim0.03$ with minimums of 
$PF\approx xx$.
% TODO: add with peaks... not sure about a-2b descriptions. 
...
Figure \ref{fig:assem-obj-3-3d} shows a 3D plot of the final generation's reactor models' 
...
\begin{figure}[htbp!]
    \begin{subfigure}{\textwidth}
        \centering
        \includegraphics[width=\linewidth]{assem-obj-3-3d.png}
        \caption{Plot of final generation's reactor models' $PF_{total}$ against 
...
Figure \ref{fig:assem-obj-3-most-minimized} shows the three reactor models on the 
Pareto front that most-minimized each objective. 
Reactor model 24 most-minimized $PF_{total}$, reactor model 4 most-minimized $T_{max}$, 
and reactor model 1 most-minimized $PPF_{fuel}$. 
\begin{figure}[htbp!]
    \begin{subfigure}{\textwidth}
        \centering
        ...
        \label{fig:assem-obj-3-distr-most-minimized}
    \end{subfigure}
    \begin{subfigure}{0.49\textwidth}
        \centering
    ...
    \begin{subfigure}{\textwidth}
        \centering
        \includegraphics[width=0.49\linewidth]{assem-obj-3-min-ppf.png}
    ...
    models on simulation a-3a's Pareto front that most-minimized each objective.
...
the most-minimized $PF_{total}$ is reactor model 24. 
Reaactor model 24 has an oscillating TRISO distribution along the both the 
...
In Figure \ref{fig:assem-obj-3-most-minimized}, the one-third assembly model with 
the most-minimized $T_{max}$ is reactor model 4. 
...
% reactor model 8 equally minimized ... 
Section \ref{sec:assem-discussion-multi} discusses and explains simulation p-3a's results.
