...
\ref{fig:a-3b-centerline-temp} are unexpectedly small. 
$r_1$, $r_2$, $r_3$, $r_4$, and $r_5$ values correspond to the FliBe channel at 18cm, 
15cm, 12cm, 8cm, and 6cm, respectively. 
...
Section\ref{sec:assem-discussion-single} concluded that only coolant channel shape 
only correlates with the minimize $T_{max}$ objective. 
