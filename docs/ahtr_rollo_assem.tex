...
\end{itemize} 
And, I optimize the \gls{AHTR} one-third assembly for the three optimization 
objectives. 
Table \ref{tab:assem-motivation} outlines the objectives, how I quantified them, and
the motivation.
\begin{table}[htbp]
    \centering
    \onehalfspacing
