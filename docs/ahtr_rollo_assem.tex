...
Figure \ref{fig:assem-obj-3-distr-most-minimized} shows the three reactor models on the 
...
\begin{figure}[htbp!]
    ...
    \begin{subfigure}{\textwidth}
        \centering
        \includegraphics[width=0.4\linewidth]{assem-obj-3-min-pf.png}
    ...
    \begin{subfigure}{\textwidth}
        \centering
        \includegraphics[width=0.4\linewidth]{assem-obj-3-min-temp.png}
    ...
    \begin{subfigure}{\textwidth}
        \centering
        \includegraphics[width=0.4\linewidth]{assem-obj-3-min-ppf.png}
