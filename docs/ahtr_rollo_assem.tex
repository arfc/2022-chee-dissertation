...
Figure \ref{fig:assem-obj-3-all-distr} shows the 12 TRISO packing fraction distributions in 
the final generation that fall on the Pareto front. 
\begin{figure}[htbp!]
    \begin{subfigure}{\textwidth}
        \centering
...
reactor model 4 most-minimized $PPF_{fuel}$, and reactor model 3 equally minimized 
all three objectives. 
\begin{figure}[htbp!]
    \centering
    \begin{subfigure}{\textwidth}
...
oscillates along the y-axis, and a packing fraction standard deviation of 
$0.0xx$ across the one-third assembly. 
Along the x-axis, the distribution peaks at the 2nd, 4th, and 9th fuel cell columns 
(at 8.2cm, 12.3cm, and 22.5cm), and minimum points at the 3rd and 10th fuel cell 
columns (at 10.3cm and 24.5cm).
The 2nd, 4th, and 9th columns have $\sim0.x$ y-axis variation with peaks of 
$PF\approx0.xx$. 
The 3rd and 10th columns have $\sim0.x$ y-axis variation with minimums of 
$PF\approx0.xx$. 
...
equally minimized all three objectives is reactor model 3. 
% re pick? 
