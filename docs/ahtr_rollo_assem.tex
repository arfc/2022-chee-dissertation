...
Section \ref{sec:plank-discussion-single} concluded that for the \gls{AHTR} plank model, 
...
$T_{max}$. 
Figures \ref{fig:assem-obj-1-temp-evol} and \ref{fig:assem-obj-1-temp-evol-coolant} show 
...
Section \ref{sec:plank-discussion-single} concluded that for the \gls{AHTR} plank 
...
Section \ref{sec:assem-discussion-double} discusses and explains simulation a-2a's 
results.
...
$PF\approx0.035$. 
Sections \ref{sec:assem-discussion-double} discusses and explains simulation a-2b's 
results.
...
Section \ref{sec:assem-discussion-double} discusses and explains simulation a-2c's 
results.
...
Section \ref{sec:plank-discussion-single} described that in the \gls{AHTR} plank model, 
...
discussions in Section \ref{sec:assem-discussion-double} and 
