...
\begin{table}[htbp!]
    ...
    \end{tabular}
\end{table}
The TRISO distribution is varied using sine distributions.  
If the simulation used the FHR benchmark equivalent $PF_{total} = 0.153$, 
at certain sine distributions, some fuel cells will have $PF > 0.3$. 
...
$PF_{total}$ that enables $k_{eff} \geq 1.38$ and will avoid $PF > 0.3$ occurences. 
