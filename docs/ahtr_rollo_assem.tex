...
\begin{table}[htbp!]
    ...
    \end{tabular}
\end{table}
Figure \ref{fig:coolant-channel-shape-assem-2} shows a \gls{AHTR} one-third 
assembly's inter-plank coolant channel shapes for 
$r_1, r_2, r_3, r_4, r_5 = 0.3, 0.2, 0.1, 0.2, 0.3$ to remind readers the 
orientation of each r value. 
\begin{figure}[htbp]
    \centering
