...
Figure \ref{fig:assem-obj-1-pf-final} shows the four TRISO packing fraction distributions 
...
\begin{figure}[htbp!]
    ...
    \begin{subfigure}{0.7\textwidth}
        \includegraphics[width=\linewidth]{assem-obj-1-pf-most-minimized.png}
...
\begin{figure}[htbp!]
    ...
    Plots of simulation p-1d final generation's reactor models $PF_{total}$ against 
...
\begin{figure}[htbp!]
    ...
    Plots of simulation p-1e final generation's reactor models $T_{max}$ against 
    coolant channel shape input parameters. 
...
Figure \ref{fig:assem-obj-1-ppf-evol} shows that the minimum, average, and maximum 
one-third assembly's $T_{max}$ converged to approximately 1.07.
In Figure \ref{fig:assem-obj-1-ppf-final}, the four TRISO packing fraction distributions 
in the final generation that most-minimized $PPF_{fuel}$ are the same with 
$PPF_{fuel} = 1.0795$.
Their TRISO distributions are somewhat constant with a small peak at 
$(x,y) = (11.8cm, 10.0cm)$. 
...
\begin{figure}[htbp!]
    ...
    AHTR one-third assembly's fuel-normalized power peaking factor ($PPF_{fuel}$). 
    Plots of simulation p-1f final generation's reactor models $PPF_{fuel}$ against 
    coolant channel shape input parameters. 
...
% comment on reactor models, 11, 22, and 17/18 
