...
\begin{figure}[htbp!]
    ...
    \end{subfigure}
    \begin{subfigure}{\textwidth}
        \includegraphics[width=\linewidth]{assem-obj-2-tempppf-pareto-distr.png}
...
% Temp and PPF objectives are not contrasting, so only one reactor model is found on the 
% pareto front. 
