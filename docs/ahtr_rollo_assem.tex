...
\begin{figure}[htbp!]
    ...
    \begin{subfigure}{\textwidth}
        ...
        The reactor model's $T_{max} = 1158.39K$, $r_1 = 0.33cm$, $r_{2} = 0.19cm$,
...
\begin{figure}[htbp!]
    \begin{subfigure}{\textwidth}
        \centering
        \includegraphics[width=0.95\linewidth]{assem-obj-2-pftemp-pareto.png}
...
x-axis and y-axis. 
On the x-axis, the distribution peaks at 14.3cm and 24.5cm with minimum points at 
8.2cm, 10.3cm, and 20.5cm. 
On the y-axis, the distribution peaks at the top and bottom row (at 3.5cm and 
19.8cm) and has a minimum point at 10.0cm. 
The maximum $\sim0.09$ x-axis variation occurs in the bottom row (at 3.5cm), and 
the average x-axis variation is $\sim0.065$. 
The maximum $\sim0.088$ y-axis occurs on the fifth column (at 14.3cm), and the average
y-axis variation is $\sim0.055$.
