...
Table \ref{tab:simulationa1f} shows simulation a-1e's optimization problem parameters. 
\begin{table}[htbp]
    \centering
    \onehalfspacing
...
the Pareto front.
Figure \ref{fig:slab-obj-2-pfppf-pareto-distr} shows the 22 TRISO packing fraction 
