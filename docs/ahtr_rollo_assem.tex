...
\end{itemize} 
Table \ref{tab:objectives} outlined these objectives and the motivation.
 
Chapter \ref{chap:method} detailed the methodology for \gls{AHTR} one-third 
assembly modeling and \gls{ROLLO} optimization. 
Section \ref{sec:ahtr-assem-geometry} described the \gls{AHTR} one-third assembly 
geometry.
Sections \ref{sec:ahtr-moltres-hom} and \ref{sec:ahtr_model_verification}
described and verified the \gls{AHTR} one-third assembly's OpenMC neutronics and Moltres 
temperature models. 
...
the $PF_{total}$ and coolant channel shape. 
