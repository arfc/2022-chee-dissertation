...
\gls{ROLLO} optimizations to understand the individual impacts of each objective 
on each input parameter. 
I then run multi objective optimizations for combinations of the input parameters 
and objectives, whose set up is informed by the single-objective optimization results. 
