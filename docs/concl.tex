...
All the single and two objective optimization simulations led to the final largest 
optimization problem: the one-third assembly multi-objective optimization that 
minimized all three objectives ($PF_{total}$, $T_{max}$, and $PPF_{fuel}$) while 
varying all the input parameters ($PF_{total}$, TRISO distribution, and coolant channel 
shape), also known as simulation a-3b-256. 
...
\texttt{\hyperlink{https://github.com/arfc/rollo/issue}{https://github.com/arfc/rollo/issue}}.
