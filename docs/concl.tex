...
By designing the \gls{ROLLO} tool and demonstrating its success in optimization 
of the \gls{AHTR} beyond classical input parameters, this dissertation contributes to 
improving reactor technology ensuring that nuclear energy continues to provide 
