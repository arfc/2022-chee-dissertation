...
This dissertation's generative design optimization of the \gls{AHTR} model was for a
beginning of life model and did not take into account the effect of burnup on 
optimization results. 
This dissertation also did not model the \gls{AHTR}'s structural mechanics 
and thermal stresses. 
Nuclear reactors represent tightly-coupled physics interactions between thermal-hydraulics, 
...
This reactor modeling conducted in this dissertation only models the neutronics 
and temperature of the \gls{AHTR}. 
There are many components of the multiphysics for any reactor model. 
Many advancements 
% many advancements are towards more tightly coupling and characterizing the 
% interactions between all these different interactions  for different reactor types. 
% The structural mechanics and material performance analysis could shed more 
% light on what material and geometric constraints we should place in reactor 
% design optimization.  
% cost analysis 
...
and example expansion to include more nuclear software.  
These issues are detailed on 
\hyperlink{ROLLO's github issues page}{https://github.com/arfc/rollo/issues}. 
...
% what improvements to ROLLO can be made? Features? 
% comment on how computational resources needed and how that is a limitation 
% effect of burnup on optimization results 
% cores are modeled at BOL, what if design looks different at higher burnups 
% we did not include material limitations of complex geometries. Will this cost more
% if parts needed to be replaced more often 
% we ignores structural mechanics and thermal stresses on design. 

% Be honest with all the potential gaps and ways things can be improved. This 
% strengthens your position and your work. 