...
fuel rods, etc. 
Fabricating reactor core components using additive manufacturing
enables optimization and improvement of core geometries. 
Thus, wide-spread adoption of additive manufacturing methods in the nuclear industry
