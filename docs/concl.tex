...
\begin{enumerate}
    ...
    through neutronics and temperature modeling by participating in the 
...
Figure \ref{fig:assem-obj-3-all} showed the 12 reactor models on simulation 
a-3b's Pareto front that met all three objectives. 
