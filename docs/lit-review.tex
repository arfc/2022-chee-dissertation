...
It was created in 2011 at \gls{MIT} as an effort to develop scalable parallel Monte 
Carlo neutron transport algorithms for future exascale supercomputers 
...
The latter is used in this dissertation for \gls{AHTR} simulation. 
