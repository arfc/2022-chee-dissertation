...
\begin{figure}[]
    ...
    \begin{subfigure}{0.49\textwidth}
        ...
        \caption{Geometric representation of outer wall spline \cite{see_design_2022}.}
        \label{fig:see1} 
    \end{subfigure}
    \begin{subfigure}{0.49\textwidth}
        \includegraphics[width=\linewidth]{see2.png}
        \caption{Geometric representation of inlet channels \cite{see_design_2022}.}
        \label{fig:see2} 
    \end{subfigure}
...
%Reactor optimization for arbitrary parameters is a very new concept and 
%very few research demonstration have been done. 
