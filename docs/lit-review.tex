...
\label{sec:opt}
Traditional manufacturing constraints result in previous efforts 
towards nuclear reactor optimization focusing on optimizing classical reactor 
...
Due to stochastic methods' many advantages, recent efforts towards nuclear 
reactor optimization use these methods. 

Additive manufacturing advancements for reactor core components remove
conventional fuel manufacturing geometric constraints such as slabs as fuel 
...
% why pick EA. Why is good? It's in Stochastic Optimization: Evolutionary Algorithm Method section
