...
To verify ROLLO’s optimization capabilities, I conducted two verification studies: 
a commonly used evolutionary algorithm benchmark problem and a nuclear 
reactor-specific problem. 
Together, they prove that ROLLO’s evolutionary algorithm is correctly implemented 
