...
During a \gls{ROLLO} simulation, \gls{ROLLO} runs nuclear reactor modeling software to calculate the 
fitness values for each reactor model in each generation. 
