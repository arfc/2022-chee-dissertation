...
\begin{itemize}
    ...
    file (pickle is a Python module that serializes Python objects). The pickled file 
    contains the \gls{ROLLO} input file and coupled evaluator's scripts enabling 
    results replication. 
\end{itemize}
...
verification methods, and convergence criteria. 
