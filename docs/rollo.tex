...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=0.8\linewidth]{figures/ackley.png} 
...
The hypervolume indicator is the most used set-quality indicators for assessing 
...
\begin{figure}[htbp]
    ...
    \caption{Example hypervolume enclosed by non-dominated solutions. Figure reproduced from 
