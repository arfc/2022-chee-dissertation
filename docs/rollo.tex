...
\begin{table}[htbp]
    ...
    \hline
    \multirow{4}{2cm}{Optional Parameters} & \texttt{execute} & enables users to run other 
    executables or files beyond the input and output scripts. 1st element: executable to 
    run file, 2nd element: file to run \\
    \cline{2-4}
