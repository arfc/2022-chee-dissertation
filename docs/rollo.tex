...
Section \ref{sec:rollo-convergence} details how the hypervolume indicator calculation.
...
For a single-objective optimization problem, a reactor designer can determine if 
