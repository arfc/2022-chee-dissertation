...
\definecolor{fhrpink1}{HTML}{ffaaff}
...
\author{Gwendolyn Jin Yi Chee}
\department{Nuclear, Plasma, and Radiological Engineering with a concentration in
...
\committee{Research Scientist Madicken Munk, Chair \\
           Associate Professor Tomasz Kozlowski \\
           Professor James F. Stubbins \\
           Assistant Professor Huy Trong Tran} 
...
%
%\include{temp_summary}

\include{intro} %chapter 1	
\include{lit-review} %chapter 2
\include{fhr-benchmark} %chapter 3
\include{rollo} %chapter 4
\include{method} % chapter 5
\include{ahtr_rollo_slab} %chapter 6
%\include{ahtr_rollo_slab_discussion} % contd chapter 6
\include{ahtr_rollo_assem} %chapter 7
%\include{ahtr_rollo_assem_discussion} % contd chapter 7
\include{concl} %chapter 8
