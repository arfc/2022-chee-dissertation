...
[Materials]
  ...
  [./ad_graphite]
    ...
    block = 'graphite1 graphite2 graphite_bot graphite_top'
  [../]
  [./ad_flibe]
    type = ADGenericConstantMaterial
    prop_names = 'k'
    prop_values = '0.01' # [W/(cm*K)] 
    block = 'flibe_bot flibe_top'
  [../]
  [./fuel1]
